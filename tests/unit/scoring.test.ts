...
// Scoring and collision detection are now server-controlled

describe('Scoring System (Server-Controlled)', () => {
  ...
  test('scoring system is now server-controlled', () => {
    // In the new architecture, scoring is handled by the server
