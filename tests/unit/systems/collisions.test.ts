...
describe('Collision System (Server-Controlled)', () => {
  ...
  test('collision detection is now server-controlled', () => {
    // In the new architecture, collision detection is done by the server
